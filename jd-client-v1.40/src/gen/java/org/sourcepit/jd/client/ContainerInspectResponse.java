...
public class ContainerInspectResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<ContainerInspectOkResponse> responseValue)
				throws IOException, JsonParseException, JsonMappingException, OkContainerInspectOkResponseException {
			throw new OkContainerInspectOkResponseException(responseValue.get());
		}
	...
	public ContainerInspectResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public <T> T match(Matcher<T> matcher)
		...
		case 200: {
			value = matcher.caseOk(new ResponseValue<>(objectMapper, ContainerInspectOkResponse.class, httpResponse));
			break;
		}
		case 404: {
	...
	public ContainerInspectOkResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, InternalServerErrorErrorResponseException {
		return match(new Matcher<ContainerInspectOkResponse>() {
			@Override
			public ContainerInspectOkResponse caseOk(ResponseValue<ContainerInspectOkResponse> responseValue)
