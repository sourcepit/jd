...
public class ContainerAttachWebsocketResponse implements Closeable {
	...
	public ContainerAttachWebsocketResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
