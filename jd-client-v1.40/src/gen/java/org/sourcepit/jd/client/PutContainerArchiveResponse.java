...
public class PutContainerArchiveResponse implements Closeable {
	...
	public PutContainerArchiveResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
		this.objectMapper = objectMapper;
		this.httpResponse = httpResponse;
	}

	public <T> T match(Matcher<T> matcher)
			throws IOException, JsonParseException, JsonMappingException, OkException, BadRequestErrorResponseException,
