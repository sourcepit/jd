...
public class ImageDeleteResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<List<ImageDeleteResponseItem>> responseValue)
				throws IOException, JsonParseException, JsonMappingException, ImageDeleteOkException {
			throw new ImageDeleteOkException(responseValue.get());
		}
	...
	public ImageDeleteResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public <T> T match(Matcher<T> matcher)
		...
		case 200: {
			value = matcher.caseOk(
					new ResponseValue<>(objectMapper, ArrayList.class, ImageDeleteResponseItem.class, httpResponse));
			break;
		}
		case 404: {
	...
	public List<ImageDeleteResponseItem> unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, ConflictErrorResponseException, InternalServerErrorErrorResponseException {
		return match(new Matcher<List<ImageDeleteResponseItem>>() {
			@Override
			public List<ImageDeleteResponseItem> caseOk(ResponseValue<List<ImageDeleteResponseItem>> responseValue)
