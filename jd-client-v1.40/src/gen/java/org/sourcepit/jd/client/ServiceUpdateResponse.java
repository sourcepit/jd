...
public class ServiceUpdateResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<ServiceUpdateResponse> responseValue)
				throws IOException, JsonParseException, JsonMappingException, OkServiceUpdateResponseException {
			throw new OkServiceUpdateResponseException(responseValue.get());
		}
	...
	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException,
			OkServiceUpdateResponseException, BadRequestErrorResponseException, NotFoundErrorResponseException,
			InternalServerErrorErrorResponseException, ServiceUnavailableErrorResponseException {
		T value;
		switch (httpResponse.getStatusLine().getStatusCode()) {
		case 200: {
			value = matcher.caseOk(new ResponseValue<>(objectMapper, ServiceUpdateResponse.class, httpResponse));
			break;
		}
		case 400: {
	...
	public ServiceUpdateResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
		...
		return match(new Matcher<ServiceUpdateResponse>() {
			@Override
			public ServiceUpdateResponse caseOk(ResponseValue<ServiceUpdateResponse> responseValue)
