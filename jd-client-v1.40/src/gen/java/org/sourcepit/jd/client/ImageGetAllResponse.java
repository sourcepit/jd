...
public class ImageGetAllResponse implements Closeable {
	...
	public ImageGetAllResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
		this.objectMapper = objectMapper;
		this.httpResponse = httpResponse;
	}

	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException,
			OkBinaryException, InternalServerErrorErrorResponseException {
		T value;
