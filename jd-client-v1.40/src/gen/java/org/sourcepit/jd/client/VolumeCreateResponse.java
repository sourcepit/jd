...
public class VolumeCreateResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseCreated(ResponseValue<Volume> responseValue)
				throws IOException, JsonParseException, JsonMappingException, CreatedVolumeException {
			throw new CreatedVolumeException(responseValue.get());
		}
	...
	public VolumeCreateResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
		this.objectMapper = objectMapper;
		this.httpResponse = httpResponse;
	}

	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException,
			CreatedVolumeException, InternalServerErrorErrorResponseException {
		T value;
		switch (httpResponse.getStatusLine().getStatusCode()) {
		case 201: {
			value = matcher.caseCreated(new ResponseValue<>(objectMapper, Volume.class, httpResponse));
			break;
		}
		case 500: {
			value = matcher
	...
	public Volume unwrap()
		...
		return match(new Matcher<Volume>() {
			@Override
			public Volume caseCreated(ResponseValue<Volume> responseValue)
