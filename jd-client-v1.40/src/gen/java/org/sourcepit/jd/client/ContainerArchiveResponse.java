...
public class ContainerArchiveResponse implements Closeable {
	public static interface Matcher<T> {
		...
		default T caseBadRequest(ResponseValue<ContainerArchiveBadRequestResponse> responseValue) throws IOException,
				JsonParseException, JsonMappingException, BadRequestContainerArchiveBadRequestResponseException {
			throw new BadRequestContainerArchiveBadRequestResponseException(responseValue.get());
		}
	...
	public ContainerArchiveResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
		this.objectMapper = objectMapper;
		this.httpResponse = httpResponse;
	}

	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException,
			OkBinaryException, BadRequestContainerArchiveBadRequestResponseException, NotFoundErrorResponseException,
		...
		case 400: {
			value = matcher.caseBadRequest(
					new ResponseValue<>(objectMapper, ContainerArchiveBadRequestResponse.class, httpResponse));
			break;
		}
		case 404: {
	...
	public InputStream unwrap() throws IOException, JsonParseException, JsonMappingException,
			BadRequestContainerArchiveBadRequestResponseException, NotFoundErrorResponseException,
			InternalServerErrorErrorResponseException {
