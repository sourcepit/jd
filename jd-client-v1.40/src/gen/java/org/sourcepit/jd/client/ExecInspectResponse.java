...
public class ExecInspectResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<ExecInspectOkResponse> responseValue)
				throws IOException, JsonParseException, JsonMappingException, OkExecInspectOkResponseException {
			throw new OkExecInspectOkResponseException(responseValue.get());
		}
	...
	public ExecInspectResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public <T> T match(Matcher<T> matcher)
		...
		case 200: {
			value = matcher.caseOk(new ResponseValue<>(objectMapper, ExecInspectOkResponse.class, httpResponse));
			break;
		}
		case 404: {
	...
	public ExecInspectOkResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, InternalServerErrorErrorResponseException {
		return match(new Matcher<ExecInspectOkResponse>() {
			@Override
			public ExecInspectOkResponse caseOk(ResponseValue<ExecInspectOkResponse> responseValue)
