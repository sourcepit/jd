...
public class NetworkInspectResponse implements Closeable {
	...
	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException,
			OkNetworkException, NotFoundErrorResponseException, InternalServerErrorErrorResponseException {
		T value;
	...
	public Network unwrap() throws IOException, JsonParseException, JsonMappingException,
