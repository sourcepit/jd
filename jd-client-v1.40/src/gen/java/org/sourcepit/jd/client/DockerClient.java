...
public interface DockerClient {
	...
	ContainerArchiveResponse containerArchive(ContainerArchiveRequest request) throws IOException;

	PutContainerArchiveResponse putContainerArchive(PutContainerArchiveRequest request) throws IOException;

	ContainerArchiveInfoResponse containerArchiveInfo(ContainerArchiveInfoRequest request) throws IOException;
	...
	BuildPruneResponse buildPrune(BuildPruneRequest request) throws IOException;
	...
	SystemPingHeadResponse systemPingHead() throws IOException;
	...
	PluginListResponse pluginList(PluginListRequest request) throws IOException;
	...
	TaskLogsResponse taskLogs(TaskLogsRequest request) throws IOException;
	...
	ConfigListResponse configList(ConfigListRequest request) throws IOException;

	ConfigCreateResponse configCreate(ConfigCreateRequest request) throws IOException;

	ConfigInspectResponse configInspect(ConfigInspectRequest request) throws IOException;

	ConfigDeleteResponse configDelete(ConfigDeleteRequest request) throws IOException;

	ConfigUpdateResponse configUpdate(ConfigUpdateRequest request) throws IOException;

	DistributionInspectResponse distributionInspect(DistributionInspectRequest request) throws IOException;

	SessionResponse session() throws IOException;
}
