...
public class DefaultDockerClient implements DockerClient {
	...
	@Override
	public ContainerCreateResponse containerCreate(ContainerCreateRequest request)
			throws BadParameterException, NoSuchContainerException, ImpossibleToAttachException, ConflictException,
			ServerErrorException, IOException {
		final Map<String, String> queryParams = new LinkedHashMap<>();
		collectQueryParameters(request, queryParams);
