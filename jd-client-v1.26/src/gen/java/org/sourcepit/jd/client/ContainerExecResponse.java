...
public class ContainerExecResponse implements Closeable {
	...
	public ContainerExecResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public IdResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, ConflictErrorResponseException, InternalServerErrorErrorResponseException {
