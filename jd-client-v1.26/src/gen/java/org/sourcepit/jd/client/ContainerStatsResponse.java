...
public class ContainerStatsResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<ContainerStatsOkResponse> responseValue)
				throws IOException, JsonParseException, JsonMappingException, OkContainerStatsOkResponseException {
			throw new OkContainerStatsOkResponseException(responseValue.get());
		}
	...
	public ContainerStatsResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public <T> T match(Matcher<T> matcher)
		...
		case 200: {
			value = matcher.caseOk(new ResponseValue<>(objectMapper, ContainerStatsOkResponse.class, httpResponse));
			break;
		}
		case 404: {
	...
	public ContainerStatsOkResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, InternalServerErrorErrorResponseException {
		return match(new Matcher<ContainerStatsOkResponse>() {
			@Override
			public ContainerStatsOkResponse caseOk(ResponseValue<ContainerStatsOkResponse> responseValue)
