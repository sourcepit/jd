...
public class ContainerUpdateResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<ContainerUpdateOkResponse> responseValue)
				throws IOException, JsonParseException, JsonMappingException, OkContainerUpdateOkResponseException {
			throw new OkContainerUpdateOkResponseException(responseValue.get());
		}
	...
	public ContainerUpdateResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public <T> T match(Matcher<T> matcher)
		...
		case 200: {
			value = matcher.caseOk(new ResponseValue<>(objectMapper, ContainerUpdateOkResponse.class, httpResponse));
			break;
		}
		case 404: {
	...
	public ContainerUpdateOkResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, InternalServerErrorErrorResponseException {
		return match(new Matcher<ContainerUpdateOkResponse>() {
			@Override
			public ContainerUpdateOkResponse caseOk(ResponseValue<ContainerUpdateOkResponse> responseValue)
