...
public class ImageTagResponse implements Closeable {
	...
	public ImageTagResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
		this.objectMapper = objectMapper;
		this.httpResponse = httpResponse;
	}

	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException,
			CreatedException, BadRequestErrorResponseException, NotFoundErrorResponseException,
