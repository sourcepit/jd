...
public class PluginCreateResponse implements Closeable {
	...
	public PluginCreateResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
		this.objectMapper = objectMapper;
		this.httpResponse = httpResponse;
	}

	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException,
			NoContentException, InternalServerErrorErrorResponseException {
		T value;
