...
public class ContainerTopResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<ContainerTopOkResponse> responseValue)
				throws IOException, JsonParseException, JsonMappingException, OkContainerTopOkResponseException {
			throw new OkContainerTopOkResponseException(responseValue.get());
		}
	...
	public ContainerTopResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public <T> T match(Matcher<T> matcher)
		...
		case 200: {
			value = matcher.caseOk(new ResponseValue<>(objectMapper, ContainerTopOkResponse.class, httpResponse));
			break;
		}
		case 404: {
	...
	public ContainerTopOkResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, InternalServerErrorErrorResponseException {
		return match(new Matcher<ContainerTopOkResponse>() {
			@Override
			public ContainerTopOkResponse caseOk(ResponseValue<ContainerTopOkResponse> responseValue)
