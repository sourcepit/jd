...
public class ImageDeleteResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<List<ImageDeleteResponse>> responseValue)
	...
	public <T> T match(Matcher<T> matcher)
		...
		case 200: {
			value = matcher.caseOk(
					new ResponseValue<>(objectMapper, ArrayList.class, ImageDeleteResponse.class, httpResponse));
			break;
		}
		case 404: {
	...
	public List<ImageDeleteResponse> unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, ConflictErrorResponseException, InternalServerErrorErrorResponseException {
		return match(new Matcher<List<ImageDeleteResponse>>() {
			@Override
			public List<ImageDeleteResponse> caseOk(ResponseValue<List<ImageDeleteResponse>> responseValue)
