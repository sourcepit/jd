...
public class ContainerWaitResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk(ResponseValue<ContainerWaitOkResponse> responseValue)
				throws IOException, JsonParseException, JsonMappingException, OkContainerWaitOkResponseException {
			throw new OkContainerWaitOkResponseException(responseValue.get());
		}
	...
	public ContainerWaitResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public <T> T match(Matcher<T> matcher)
		...
		case 200: {
			value = matcher.caseOk(new ResponseValue<>(objectMapper, ContainerWaitOkResponse.class, httpResponse));
			break;
		}
		case 404: {
	...
	public ContainerWaitOkResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
			NotFoundErrorResponseException, InternalServerErrorErrorResponseException {
		return match(new Matcher<ContainerWaitOkResponse>() {
			@Override
			public ContainerWaitOkResponse caseOk(ResponseValue<ContainerWaitOkResponse> responseValue)
