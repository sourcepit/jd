...
public class ContainerCreateResponse implements Closeable {
	public static interface Matcher<T> {
		...
		default T caseNotAcceptable(ResponseValue<ErrorResponse> responseValue)
				throws IOException, JsonParseException, JsonMappingException, NotAcceptableErrorResponseException {
			throw new NotAcceptableErrorResponseException(responseValue.get());
		}
	...
	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException,
			...
			NotFoundErrorResponseException, NotAcceptableErrorResponseException, ConflictErrorResponseException,
		...
		case 406: {
			value = matcher.caseNotAcceptable(new ResponseValue<>(objectMapper, ErrorResponse.class, httpResponse));
			break;
		}
		case 409: {
	...
	public ContainerCreateCreatedResponse unwrap() throws IOException, JsonParseException, JsonMappingException,
			BadRequestErrorResponseException, NotFoundErrorResponseException, NotAcceptableErrorResponseException,
