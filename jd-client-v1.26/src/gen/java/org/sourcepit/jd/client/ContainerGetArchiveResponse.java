...
public class ContainerGetArchiveResponse implements Closeable {
	public static interface Matcher<T> {
		default T caseOk() throws IOException {
			throw new OkException();
		}

		default T caseBadRequest(ResponseValue<ContainerGetArchiveBadRequestResponse> responseValue) throws IOException,
				JsonParseException, JsonMappingException, BadRequestContainerGetArchiveBadRequestResponseException {
			throw new BadRequestContainerGetArchiveBadRequestResponseException(responseValue.get());
		}
	...
	public ContainerGetArchiveResponse(ObjectMapper objectMapper, HttpResponse httpResponse) {
	...
	public <T> T match(Matcher<T> matcher) throws IOException, JsonParseException, JsonMappingException, OkException,
		...
		case 400: {
			value = matcher.caseBadRequest(
					new ResponseValue<>(objectMapper, ContainerGetArchiveBadRequestResponse.class, httpResponse));
			break;
		}
		case 404: {
